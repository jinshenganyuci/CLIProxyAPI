...
本分支基于 CLIProxyAPI `v7.2.149`（上游提交
`2a6b87aca083a5bf498ac1f68a1b636c500d7aaa`），目标是让每个 Codex OAuth
...
2. 把 `CLI_PROXY_IMAGE` 改为
   `jinshenganyuci/cli-proxy-api:codex-identity-v7.2.149.1`，保持现有 volumes 不变。
