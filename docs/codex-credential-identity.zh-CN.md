...
本分支基于 CLIProxyAPI `v7.2.142`（上游提交
`1f53b2eb03b9e963bac647e5566ca2b304239116`），目标是让每个 Codex OAuth
...
2. 把 `CLI_PROXY_IMAGE` 改为
   `jinshenganyuci/cli-proxy-api:codex-identity-v7.2.142.1`，保持现有 volumes 不变。
